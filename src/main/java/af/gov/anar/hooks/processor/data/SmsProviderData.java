...
package af.gov.anar.hooks.processor.data;

import static af.gov.anar.hooks.api.HookApiConstants.payloadURLName;
import static af.gov.anar.hooks.api.HookApiConstants.phoneNumberName;
import static af.gov.anar.hooks.api.HookApiConstants.smsProviderAccountIdName;
import static af.gov.anar.hooks.api.HookApiConstants.smsProviderName;
import static af.gov.anar.hooks.api.HookApiConstants.smsProviderTokenIdName;
